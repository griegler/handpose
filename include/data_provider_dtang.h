#ifndef DATA_PROVIDER_DTANG_H
#define DATA_PROVIDER_DTANG_H
...
class DataProviderDTang : public DataProvider<Dtype> {
public:
  DataProviderDTang(const pose::DataProviderParameter& param);
  virtual ~DataProviderDTang() {}
